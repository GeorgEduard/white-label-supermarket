...
const products = [
  {
    ...
    price: 3.99,
    description: 'Rich and moist chocolate cake topped with a cherry.',
  ...
  },
  {
    ...
    price: 2.49,
    description: 'Crisp green spears, perfect for roasting or grilling.',
    image: '/products-asparagus.svg',
    promo: null,
  },
  {
    id: 'kitty-litter',
    name: 'Clumping Kitty Litter (10L)',
    price: 1.79,
    description:
      'Low-dust, fast-clumping litter for a fresher, cleaner litter box.',
    ...
    <div className="space-y-6">
      ...
      <ul className="grid gap-4 sm:gap-6">
        {products.map(p => (
          <li
            key={p.id}
            className="flex gap-4 sm:gap-6 items-center p-4 rounded-lg border border-emerald-100 bg-white/80 shadow-sm hover:shadow-md transition-shadow duration-200"
          >
